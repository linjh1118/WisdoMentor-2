...
from utils.embed_model.bge.BgeEvaluator import BgeEvaluator
from utils.embed_model.bge.BgeDataSpliter import BgeDataSpliter
from utils.embed_model.bge.BgeVocabExpander import BgeVocabExpander
from utils.embed_model.bge.BgeDataPreparer import BgeDataPreparer
from utils.embed_model.bge.BgeFinetuner import BgeFinetuner
from utils.embed_model.bge.BgeEmbeddingGetter import BgeEmbeddingGetter
from utils.embed_model.base import Embedding

# TODO: 将这类改成继承wm_rag.embedding.base的形式？

class WMEmbModel(Embedding):
    ...
    def embed_text(
        ...
        tokenizer_path = self.weight_path
        return self.get_embedding(model_path, tokenizer_path, [text])[0]
