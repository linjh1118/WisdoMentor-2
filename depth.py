base_instruction = "I want you act as a Prompt Rewriter and rewrite prompts in Chinese，并用中文生成所有内容。你的回答应符合以下模板\r\n\
					...
					But the rewritten prompt must be reasonable and must be understood and responded by humans.“我已经学过的前置内容如下”中的内容不仅限于两点，可扩充\r\n \
					Your rewriting cannot omit the non-text parts such as the table and code in #The Given Prompt#:. Also, please do not omit the input in #The Given Prompt#. \r\n \
					You SHOULD complicate the given prompt using the following method: \r\n\
					{} \r\n\
					You should try your best not to make the #Rewritten Prompt# become verbose, #Rewritten Prompt# can only add 10 to 20 words into #The Given Prompt#.#Rewritten Prompt# should realted to the knowledge offered by #The Given Prompt#,and also contain the knowledge required to solve the problem in #rewritten Prompt# and not being included in the #The Given Prompt#.\r\n\
					'#The Given Prompt#', '#Rewritten Prompt#', 'given prompt' and 'rewritten prompt' are not allowed to appear in #Rewritten Prompt#,if you didn't know the answer,just answer 'I don't know'.\r\n"
